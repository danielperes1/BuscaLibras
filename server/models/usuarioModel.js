...
module.exports = {
  buscarPorEmail: async (email) => {
    // Recupera o usuário que corresponde ao email informado
  ...
  criarUsuario: async (email, senha, perfil) => {
    // Insere o registro principal do usuário na tabela usuarios
  ...
  criarProfissional: async (
    ...
    // Insere dados específicos do perfil profissional
  ...
  buscarNomePorIdUsuario: async (id_usuario, perfil) => {
    // Busca o nome do usuário na tabela correta conforme o perfil
  ...
  criarSolicitante: async (
    ...
    // Insere dados específicos do perfil solicitante
  ...
  contarPorPerfil: async (perfil) => {
    // Retorna a quantidade de usuários com o perfil informado
  ...
  listarUsuariosCompletos: async () => {
    // Retorna informações completas dos usuários não administradores para a dashboard
    const query = `
